...
function openModal(event) {
  ...
  document.addEventListener('keydown', closeModalOnEscape.bind(null, instance));
}

function closeModalOnEscape(instance, event) {
  if (event.key === 'Escape') {
    instance.close();
...
// `,
//     {
//       onShow: () => galleryEl.addEventListener('keydown', onClosesModalWindowUsingEscape),
//       onClose: () =>
//         galleryEl.removeEventListener('keydown', onClosesModalWindowUsingEscape, false),
//     }
//   );
